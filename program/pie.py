# -*- coding: utf-8 -*-
"""
Created on Mon Aug 23 21:49:45 2021
...
for i in range(len(df["ID"])):
    ...
    text="貴事業所の位置"
    ax.text(0.8,1.2,text,bbox=boxdic,size=10)
    ...
    ax1.set_title("AI利用状況")
    pie,pie_1=ax1.pie(num,startangle=90,labels=label_1,counterclock=False,labeldistance=1.1)
    boxdic = {
        "facecolor" : "white",
        "edgecolor" : "red",
        "boxstyle" : "square",
    ...
    ax1.annotate('',(1.25,1.25), xytext=(pie_1[lab_i]._x*0.7,pie_1[lab_i]._y*0.7),
                        arrowprops=dict(arrowstyle='<|-', 
                                        connectionstyle='arc3', 
                                        facecolor='black', 
                                        edgecolor='black')
    ...
    text="貴事業所の位置"
    ax1.text(0.8,1.2,text,bbox=boxdic,size=10)
    ...
    ax2.set_title("3D CAD/CAMの利用状況")
    pie,pie_1=ax2.pie(num,startangle=90,labels=label_1,counterclock=False,labeldistance=1.1)
    boxdic = {
            "facecolor" : "white",
        "edgecolor" : "red",
        "boxstyle" : "square",
    ...
    ax2.annotate('',(1.25,1.25), xytext=(pie_1[lab_i]._x*0.7,pie_1[lab_i]._y*0.7),
                        arrowprops=dict(arrowstyle='<|-', 
                                        connectionstyle='arc3', 
                                        facecolor='black', 
                                        edgecolor='black')
    ...
    text="貴事業所の位置"
    ax2.text(0.8,1.2,text,bbox=boxdic,size=10)
    file_name="../data/pie_Q26/"+str(a["ID"])+"_pie26.png"
